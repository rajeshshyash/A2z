...
<title>A2zcinema | Scriptwriting</title>
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default">
					<img src="static/mainfiles/img/scriptwriting.jpg"
						style="width: 400px; height: 400px" />
				</div>
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						A2Z Cinema.com Pvt. Ltd delivers movie making service in short
						time in an impressive way of reaching out to the audience. We take
						the ownership of producing complete movie starting from
						Development of movie to release of the movie in the theatres/home
						theatres.</br> A2Z Cinema.com’s Movie Making Team consists of Eminent
						Directors, Story Writers, Screen Play writers, Dialogue writers,
						Cinematographers (Cameraman), Choreographers, Producers and
						selective public including media friends to take their opinion for
						the best outcome.
					</h4>
					</br>

					<p>Note: Film production is the process of making a film.
						Filmmaking involves a number of discrete stages including an
						initial story, idea, or commission, through scriptwriting,
						casting, shooting, reproduction, editing, and screening the
						finished product before an audience that may result in a film
						release and exhibition. Filmmaking takes place in many places
						around the world in a range of economic, social, and political
						contexts, and using a variety of technologies and cinematic
						techniques. Typically, it involves a large number of people, and
						can take from a few months to several years to complete</p>
					</br>
