...
<title>A2zcinema | Crowdfunding</title>
	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						Want to make movies through crowd funding? </br>
						</br> A2Z Cinema.com Pvt. Ltd provides the platform through Mobile App
						and Website for you now and forever. Just a single click takes you
						online registration process and uploading your personal and
						professional details.</br> </br> For good featured movies along with a good
						story, a script and plans, a production budget also plays a vital
						role. Get money invested from public through Crowd funding method
						in movie making.</br>
						<br> Anyone and everybody can become PUBLIC- PRODUCERS by
						investing the money starting from ‘ONE LAKH RUPEE’ OR more on
						their capability and the make money.</br>
					</h4>
					</br>
					<p>Note: Crowd funding (a form of crowd sourcing) is the
