	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						Are you a good businessman OR want to be a businessman and want to
						make money in the film industry?</br>
						</br> Now our company renders an online distribution facility for you.
						By registering on website or via mobile app, you (any
						individual/group) can hire/rent a theatre OR theatres to release
						new/Old movies and can make money. If you hire/rent a theatre at
						your native OR at a nearby places that would be a great plot form
						for you to save your cast and make good money.
					</h4>
					</br>
					<p>
						Note: A film distributor is responsible for the marketing of a
						film. The distribution company is usually different from the
						production company. Distribution deals are an important part of
						financing a film.</br> The distributor may set the release date of a
						...
						theatrically or for home viewing (DVD, video-on-demand, download,
						television programs through broadcast syndication etc.). A
						distributor may do this directly, if the distributor owns the
						theaters or film distribution networks, or through theatrical
