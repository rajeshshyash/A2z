	...
	<div class="sidebar-menu-container" id="sidebar-menu-container">
		...
		<section>
			...
			<div class="col-lg-12 panel panel-default" style="height: 550px">
				...
				<div class="col-lg-6 panel panel-default  ">
					<h4>
						A2Z Cinema.com Pvt. Ltd does prepare a complete Story Board that
						...
						movie makers’ time, money and foremost the producer. The Story
						Board also helps the director while shooting to avoid the
						continuity misses like shots wise, Expression wise, Angle wise,
						dialogue wise and other stuffs. </br> A2Z Cinema.com’s Script Team
